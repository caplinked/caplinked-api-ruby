...
describe Caplinked::Client, :vcr => true do
  ...
  it 'Upload a File' do
    VCR.use_cassette("files/upload_file") do
      ...
      new_file = client.upload_file workspace_id: 5886, folder_id: 32277, file_name: 'pg_0317.pdf', file: File.read('/Users/jazz/Dropbox/TestData/CukeBook 2/index/pg_0317.pdf')
