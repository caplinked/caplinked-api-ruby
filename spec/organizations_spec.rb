...
describe Caplinked::Client, :vcr => true do
  ...
  it 'get organization info' do
    VCR.use_cassette("organizations/get_organization_info", :record => :none, :record => :none) do
  ...
  it 'update organization info' do
    VCR.use_cassette("organizations/update_organization_info", :record => :none) do
  ...
  it 'update organization info' do
    VCR.use_cassette("organizations/update_organization_support_info", :record => :none) do
  ...
  it 'add organization member' do
    VCR.use_cassette("organizations/add_organization_member", :record => :none) do
  ...
  it 'remove organization member' do
    VCR.use_cassette("organizations/remove_organization_member", :record => :none) do
